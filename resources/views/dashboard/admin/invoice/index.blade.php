...
@section('content')
                ...
                <div class="kt-portlet__head-wrapper">
                    <div class="kt-portlet__head-actions">
                        ...
                        <a href="javascript:;" type="button" id="create" class="btn btn-brand btn-elevate btn-icon-sm">
                            <i class="la la-plus"></i>{{ __('dashboard.add-new-invoice') }} </a>
                    </div>
                </div>
            </div>
        </div>
    ...
    <!--begin::Modal -->
    {{-- @include('dashboard.admin.invoice.create') --}}
    <!--end::Modal -->
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">{{ __('dashboard.all-invoices') }}</h3>
        ...
        jQuery(document).ready(function() {
            ...
            table.DataTable({
                ...
                columns: [{
                    ...
                    {
                        data: 'appointment_id',
                        title: "{{ __('datatable.appointment-id') }}"
                    },
                    {
                        data: 'patient_name',
