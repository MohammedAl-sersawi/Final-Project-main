<div class="kt-portlet__body">
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-8 col-md-9 col-sm-12">
            <input type='text' class="form-control" name="addressar" placeholder="{{ __('form.address') }}" />
        </div>
    </div>
    <div class="form-group row">
        <label class="col-form-label col-lg-3 col-sm-12">address</label>
        <div class="col-lg-8 col-md-9 col-sm-12">
            <input type='text' class="form-control" name="addressen" placeholder="{{ __('form.address') }}" />
        </div>
    </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-4 col-md-9 col-sm-12">
            <div class='kt-radio-inline'>
                ...
                <label class="kt-radio">
                    <input type="radio" name="gender" value="female"> {{ __('patient.female') }}
                    <span></span>
                </label>
            </div>
        </div>
