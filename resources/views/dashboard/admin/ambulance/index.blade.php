...
@section('content')
    ...
    <!--begin::Modal -->
    @include('dashboard.admin.ambulance.create')
    <!--end::Modal -->
    ...
    <script>
        jQuery(document).ready(function() {
            ...
            table.DataTable({
                responsive: true,
                ajax: {
                    route: "{!! route('admin.ambulances.index') !!}",
                    type: 'GET',
                    data: {
                        pagination: {
                            perpage: 50,
            ...
            $(document).on('click', '#kt_blockui_4_4', function(e) {
                e.preventDefault();
                var ajaxRoute = '{!! route('admin.ambulances.store') !!}';
                var ambulanceid = $(this).data('id');
                var ajaxData = $('.kt_form').serialize();
                var ajaxMethod = 'POST';
                if (ambulanceid) {
                    ajaxRoute = '{!! route('admin.ambulances.update', ['ambulance' => '__id__']) !!}';
