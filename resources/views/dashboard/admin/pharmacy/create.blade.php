...
@section('content')
    ...
    <div class="kt-portlet">
        ...
        <form method="POST" class="kt-form kt-form--label-right" id="kt_form_1">
            @csrf
            @include('dashboard.admin.pharmacy._form')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            <div class="kt-subheader__main">
                <h3 class="kt-subheader__title">{{ __('dashboard.add-new-pharmacy') }}</h3>
                ...
                <div class="kt-subheader__breadcrumbs">
                    ...
                    <a href="{{ route('admin.pharmacies.index') }}"
                        class="kt-subheader__breadcrumbs-link">{{ __('dashboard.pharmacies') }}</a>
