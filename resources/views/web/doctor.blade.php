...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url({{ asset('siteassets/images/background/bad1.jpg') }});">
        <div class="auto-container">
            <h1>Pricetable For CareNet</h1>
	...
	<!-- Appointment Section -->
	<section class="appointment-section" style="background-image:url({{ asset('siteassets/images/background/pattern-5.png') }})">
		<div class="auto-container">
			...
			<div class="row clearfix">
				...
				<div class="image-column col-lg-6 col-md-12 col-sm-12">
					<div class="inner-column wow slideInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
						<div class="image">
							<img src="{{ asset('siteassets/images/background/bed2.jpg') }}" alt="" />
						</div>
					</div>
				</div>
