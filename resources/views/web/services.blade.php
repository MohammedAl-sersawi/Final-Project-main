...
<div class="page-wrapper">
	...
	<!--Page Title-->
    <section class="page-title" style="background-image:url({{ asset('siteassets/images/background/bluns.jpg') }})">
        <div class="auto-container">
            <h1>Services CareNet</h1>
    ...
    <section class="fluid-section-one">
		<div class="outer-section clearfix">
           ...
           <!--Image Column-->
        	<div class="image-column" style="background-image:url({{ asset('siteassets/images/background/nurse.jpg') }})">
            	<div class="image">
                	<img src="{{ asset('siteassets/images/background/nurse.jpg') }}" alt="">
                </div>
            </div>
            <!--End Image Column-->
