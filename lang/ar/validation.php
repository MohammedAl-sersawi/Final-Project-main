...
return [
    ...
    'ascii' => 'يجب أن يحتوي الحقل :attribute على أحرف وأرقام أحادية البايت فقط.',
    ...
    'between' => [
        ...
        'string' => 'يجب أن يحتوي الحقل :attribute بين :min و :max أحرف.',
    ],
    ...
    'gte' => [
        ...
        'string' => 'يجب أن يحتوي الحقل :attribute على :value أحرف أو أكثر.',
    ],
    ...
    'lte' => [
        ...
        'string' => 'يجب أن يحتوي الحقل :attribute على أقل من أو يساوي :value أحرف.',
    ],
    ...
    'max' => [
        ...
        'string' => 'يجب أن لا يحتوي الحقل :attribute على أكثر من :max أحرف.',
    ],
    ...
    'attributes' => [
        ...
        'lastnamear' => 'الاسم الثاني بالعربية',
        'firstnameen' => 'الاسم الأول بالإنجليزية',
        'lastnameen' => 'الاسم الثاني بالإنجليزية',
    ],
];
